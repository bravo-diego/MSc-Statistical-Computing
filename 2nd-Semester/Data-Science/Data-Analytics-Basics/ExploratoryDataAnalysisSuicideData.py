...
path = "/home/aspphem/Desktop/MCE/DataScience/T1/Datasets/suicide_data.csv" # file path
...
# Note that although the plots provide a general overview of the trend in suicide rates for men and women in Latin America, additional information are still needed to fully understand the factors that may explains this phenomenon.
